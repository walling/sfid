...
assert.equal('80120000000testAAA' , sfid('80120000000TESTAAA'));
assert.equal('80120000000tEsTAAF' , sfid('80120000000TESTAAF'));
...
assert.equal('80120000000tesTAAB' , sfid('80120000000TESTAAB'));
assert.equal('80120000000testAAA' , sfid('80120000000testaaa'));
...
assert.equal('MyType2' , sfid.guessType('TST20000000test2AA')[0]);
assert.equal('MyType3' , sfid.guessType('TST20000000test2AA')[1]);
